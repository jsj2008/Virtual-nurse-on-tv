...
@implementation classMesureWeight1
...
-(void)showGlucoseMessage
{
    ...
    optionIndex=1;
    //class log
    classLog * objLog=[[classLog alloc] initWithNibName:@"classLogs" bundle:nil]; 
    ...
    //synk
    classSynkData * objSynk=[[classSynkData alloc] initWithNibName:@"classSynk" bundle:nil];
...
-(void)showMesureWightAlert
{
    ...
    // play audio to mesure weight  
    [array addObject:@"PleaseMeasureWeight12"];
  //  [myAudioPlayer playAudios:array];
  //  NSLog(@"%@",myAudioPlayer);
    [array release];
}
