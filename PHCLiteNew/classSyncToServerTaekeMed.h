...
@protocol protocolSynkToServerTakeMed
...
@interface classSyncToServerTaekeMed : UITableViewController<webServiceDelegateProtocol> {
    classUser * objUser;
...
@property(nonatomic,assign)   id<protocolSynkToServerTakeMed>delegate;
