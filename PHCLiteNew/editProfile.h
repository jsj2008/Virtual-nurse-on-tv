...
@interface editProfile : UIViewController <UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
{
    ...
    id<protocolUpdateUser>delegate;
...
@property(nonatomic,assign) id<protocolUpdateUser>delegate;

@property(nonatomic,retain)classUser * objUser,*aUser;
