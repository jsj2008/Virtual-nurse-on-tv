...
//    UIAlertView * alert=[[UIAlertView alloc]initWithTitle:@"Take Medicine " message:@"Tap Box to take Medicine " Delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
   ...
   // [myView addSubview:scrollView];
    ...
    UIBarButtonItem *rightbtn =[[[UIBarButtonItem alloc]initWithTitle:@"Done" style:UIBarButtonItemStyleDone target:self action:@selector(done)]autorelease];
    self.navigationItem.rightBarButtonItem=rightbtn;
    UIBarButtonItem *leftbtn =[[[UIBarButtonItem alloc]initWithTitle:@"Medicine List" style:UIBarButtonItemStyleDone target:self action:@selector(methodMedList)]autorelease];
...
-(void)print
{
    ...
    if(result==0 && result1 ==0)
    {
        ...
        UILabel *msg=[[[UILabel alloc]initWithFrame:CGRectMake(20, 200, 250, 50)]autorelease];
...
//            lblNO.text=@"1";
           ...
           // [aButton setTitle:[NSString stringWithFormat:@"%@", [arrayMed objectAtIndex:i] ]forState:UIControlStateNormal]; 
            ...
            UILabel *lbl=[[[UILabel alloc]initWithFrame:CGRectMake(10, 55, 100, 30)]autorelease];
            ...
            UILabel *lblQty=[[[UILabel alloc]initWithFrame:CGRectMake(10, 85, 50, 20)]autorelease];
            lblQty.text=qty;
